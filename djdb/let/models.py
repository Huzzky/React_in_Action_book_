...
class User(models.Model):
    ...
    img_user = models.FileField(upload_to='img/users', max_length=100,null=True, default="" ,blank=True)
...
class Post(models.Model):
    ...
    image_post = models.FileField(upload_to='img/posts', max_length=100, default="" ,null=True, blank=True)
